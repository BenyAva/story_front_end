    ...
    return(
        <div className="Story" style={{backgroundImage: `url(${images[level]})`, backgroundSize: 'cover',backgroundRepeat: 'no-repeat',backgroundPosition: 'center', width: '100%', height: '100%'}}>
            ...
            <>
                ...
                {health <= 0 ? <p> Unfortunately, The Shadow was defeated. </p> : <p> The Shadow emerged victorious, having defeated the bounty hunter. The Shadow decides to spare his life and take the day off and flee to a new town. The end. </p>}
